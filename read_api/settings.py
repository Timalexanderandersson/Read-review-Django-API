"""
Django settings for read_api project.
...
SECRET_KEY = 'django-insecure-b1*9mz$vy4#*cjzl_ew_#2@_6u10sbj+=&^!s2+2mv)5am8x^r'
...
WSGI_APPLICATION = 'read_api.wsgi.application'
